...
public class BirchCanopyType extends Canopy {
    public static final MapCodec<BirchCanopyType> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public BirchCanopyType(BlockStateProvider leaves) {
        this.leaves = leaves;
    }

    @Override
    protected CanopyType<?> type() {
        return CanopyType.BIRCH_CANOPY_TYPE.get();
    }
