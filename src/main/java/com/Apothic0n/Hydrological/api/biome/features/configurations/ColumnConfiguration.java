...
public class ColumnConfiguration implements FeatureConfiguration {
    public static final Codec<ColumnConfiguration> CODEC = RecordCodecBuilder.create((p_160966_) -> {
        return p_160966_.group(BlockStateProvider.CODEC.fieldOf("material").forGetter((p_160984_) -> {
            return p_160984_.material;
        ...
        })).apply(p_160966_, ColumnConfiguration::new);
    });
    ...
    public ColumnConfiguration(BlockStateProvider material, int p_160956_, IntProvider p_160957_, FloatProvider p_160958_, float p_160959_, FloatProvider p_160960_, FloatProvider p_160961_, FloatProvider p_160962_, int p_160963_, float p_160964_) {
