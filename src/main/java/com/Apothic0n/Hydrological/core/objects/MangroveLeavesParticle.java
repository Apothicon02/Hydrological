...
public class MangroveLeavesParticle extends TextureSheetParticle {
    ...
    public MangroveLeavesParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
